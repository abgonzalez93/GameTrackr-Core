...
/**
 * Zod schema for validating a base64-encoded JWT secret.
 *
 * Minimum 32 characters (256 bits) for security.
 */
export const JwtSecretSchema = z
  .string()
  .min(32, { message: 'Must be at least 256 bits (32 characters base64)' })
