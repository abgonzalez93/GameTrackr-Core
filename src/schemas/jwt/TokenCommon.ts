 ...
 */
export const TokenSubSchema = z.string().regex(/^\d+$/, { message: 'sub must be a numeric string' })
 ...
 */
export const TokenJtiSchema = z.string().uuid({ message: 'jti must be a valid UUID' })
 ...
 */
export const TokenExpSchema = PositiveNumberSchema
